...
$indexlink= '<a href="Admission"><i style="font-size:25px" class="fa fa-chevron-circle-left" aria-hidden="true"></i>
</a>';
?>
        ...
        <div id="content" class="clearfix">
            <div class="contentwrapper">
                ...
                <?php
					...
					$row = $student->selectOne();
					$title = $row['GirlName']."--".$row['OOSG_CODE'];
					$BreadCumb=$indexlink; BreadCumb($BreadCumb);
					 echo '<p style="background-color:white; font-size:20px;"><b>'.$title.'</b><p>';
					...
					if (isset($_POST['admit'])){
						$student->OOSG_CODE = $_POST['OOSG_CODE'];
						if($_POST['CohortId'] == null){
							$admissionTask = "You Must Select a Cohort!!";	
						}else{
							$id = $student->checkIfStudentExist();
					
							if($id == 1){
								$admissionTask = "Learner Already Admitted";
							}else{
								$student->CohortId= $_POST['CohortId'];
								$student->admitStudent();
								$admissionTask = "Learner has been Admitted";
								$row = $student->selectOne();
                        ...
                        <div class="box chart gradient">
                            ...
                            <div class="content" style="width:98%; margin-bottom:10px; float:left; clear:both; ">
								...
								<div>
										...
										<button style="width:90px" type="submit" name="admit" tabindex="20" class="btn btn-info">Admit</button>

										<a  style="width:150px" href="Admission" class="btn btn-primary">Back</a>
