...
if(!empty($_POST) && isset($_POST))
{
  ...
  $query2="select FeeStructure from studentfee where Session='$CURRENTSESSION' and term='$CURRENTTERM' and AdmissionId='$AdmissionId' and SectionId='$SectionId' ";
  ...
  //elseif($Amount>$TotalFeeTypeAmount)
	//echo "<div class=\"alert alert-error\">Selected fee is only $TotalFeeTypeAmount KES is due!!</div>";
  elseif($count1>0)
