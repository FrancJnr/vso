								...
								<div class="row-fluid">
									...
									<div class="span4">
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="AffiliatedBy">Receipt/Invoice Label</label>
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													<label class="form-label span4" for="DateOfEstablishment">KCPE END</label>
													<input class="span8" tabindex="20"  id="kcpe_end" type="text" name="kcpe_end" value="<?php echo $kcpe_end; ?>" />
												</div>
											</div>
										</div>
										<input type="hidden" name="RandomNumber" value="<?php echo $TOKEN; ?>" readonly>
											<input type="hidden" name="Action" value="GeneralSetting" readonly>
										<?php $ButtonContent="Save"; ActionButton($ButtonContent,20, "Submit"); ?>
									</div>
								</div>
								</form>
                            </div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if($('#kcpe_end').length) {
		$('#kcpe_end').datepicker({ yearRange: "-180:+0", dateFormat: 'dd-mm-yy',changeMonth: true, changeYear: true });
		}
