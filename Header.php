                        ...
                        <li class="dropdown">
							...
							<ul class="dropdown-menu scroll" style="height:200px; overflow:auto; margin-top:10px;">
								...
								<li><a href="ManageSubject"><span class="icon16 icomoon-icon-picture-3"></span><?php echo Translate('Manage Subject'); ?></a></li>
                                                                <li><a href="ManageSubjectPosition"><span class="icon16 icomoon-icon-picture-3"></span><?php echo Translate('Manage Subject Preferences'); ?></a></li>
								<li><a href="SubjectTeachers"><span class="icon16 icomoon-icon-picture-3"></span><?php echo Translate('Subject Teachers'); ?></a></li>
								<li><a href="ManageExam"><span class="icon16 icomoon-icon-meter-slow"></span><?php echo Translate('Manage Progress Reports'); ?></a></li>
